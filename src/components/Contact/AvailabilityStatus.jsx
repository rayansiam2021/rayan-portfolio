      ...
      <div className="flex flex-col gap-4 p-6 rounded-2xl bg-[#030712] border border-white/5 relative overflow-hidden group">
        <div className="flex items-center gap-3 relative z-10">
          ...
          <GradientText
            ...
            className="text-xs font-black uppercase tracking-[0.25em] italic"
          >
            ACTIVE_MODE // READY_FOR_SIGNALS
          </GradientText>
        </div>
        <p className="text-[14px] text-slate-400 leading-relaxed relative z-10 font-medium italic">
          Currently <span className="text-emerald-400 font-bold">Operational</span>. I am prioritizing 
          complex <span className="text-slate-200">Frontend architectures</span> and <span className="text-slate-200">IoT sensor integrations</span>.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div className="relative p-[1px] rounded-2xl overflow-hidden bg-white/5 group">
          ...
          <div className="relative z-10 bg-[#030712] rounded-[calc(1rem-1px)] p-6 flex flex-col gap-2">
             ...
             <span className="text-[9px] text-slate-600 font-bold uppercase tracking-widest italic">UTC+6 // DHAKA, BD</span>
          </div>
        </div>
        ...
        <div className="relative p-[1px] rounded-2xl overflow-hidden bg-white/5 group">
          ...
          <div className="relative z-10 bg-[#030712] rounded-[calc(1rem-1px)] p-6 flex flex-col gap-3 h-full justify-between">
             ...
             <div>
                <p className="text-sm font-black text-slate-200">High_Priority</p>
                <p className="text-[10px] text-slate-500 font-bold italic">Response within 24h</p>
             </div>
